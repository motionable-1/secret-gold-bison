...
export const GeoBurst: React.FC = () => {
  ...
  const shapes: FloatingShapeProps[] = [
    { x: width * 0.15, y: height * 0.2, size: 80, color: COLORS.blue, delay: 15, rotation: 180, shape: "triangle" },
    { x: width * 0.75, y: height * 0.15, size: 60, color: COLORS.gold, delay: 18, rotation: -120, shape: "hexagon" },
    { x: width * 0.85, y: height * 0.6, size: 70, color: COLORS.pink, delay: 21, rotation: 90, shape: "diamond" },
    { x: width * 0.1, y: height * 0.7, size: 55, color: COLORS.blue, delay: 24, rotation: -200, shape: "circle" },
    { x: width * 0.5, y: height * 0.1, size: 50, color: COLORS.berry, delay: 20, rotation: 150, shape: "square" },
    { x: width * 0.65, y: height * 0.8, size: 65, color: COLORS.gold, delay: 27, rotation: -90, shape: "triangle" },
    { x: width * 0.3, y: height * 0.85, size: 45, color: COLORS.pink, delay: 22, rotation: 270, shape: "hexagon" },
    { x: width * 0.9, y: height * 0.35, size: 40, color: COLORS.berry, delay: 25, rotation: -150, shape: "diamond" },
    { x: width * 0.35, y: height * 0.45, size: 35, color: COLORS.blue, delay: 30, rotation: 60, shape: "circle" },
    { x: width * 0.6, y: height * 0.5, size: 45, color: COLORS.gold, delay: 28, rotation: -45, shape: "square" },
  ];
